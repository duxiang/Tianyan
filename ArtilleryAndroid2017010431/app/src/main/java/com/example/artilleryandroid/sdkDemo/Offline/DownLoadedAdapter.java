package com.example.artilleryandroid.sdkDemo.Offline;
...
import com.example.artilleryandroid.sdkDemo.*;
...
public class DownLoadedAdapter extends BaseExpandableListAdapter {
	...
	public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		v2.setText(OfflineMapDemoList.OFFLINE_TYPENAME[map.getType()] + " version:" + map.getVersion());
		return convertView;
	}
