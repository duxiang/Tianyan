...
public class DrivingDemo extends Activity implements OnClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.artilleryandroid.R.layout.drivingdemo);
		mMapView = (MapView) findViewById(com.example.artilleryandroid.R.id.driving_mapview);
		mBtnStart = (Button) this.findViewById(com.example.artilleryandroid.R.id.start);
		mBtnEnd = (Button) this.findViewById(com.example.artilleryandroid.R.id.end);
		mBtnRoute = (Button) this.findViewById(com.example.artilleryandroid.R.id.route);
		mBtnReset = (Button) this.findViewById(com.example.artilleryandroid.R.id.reset);
		mBtnAddAve = (Button) this.findViewById(com.example.artilleryandroid.R.id.add_ave);
		mBtnAve1 = (Button) this.findViewById(com.example.artilleryandroid.R.id.ave_1);
		mBtnAve2 = (Button) this.findViewById(com.example.artilleryandroid.R.id.ave_2);
		mBtnAve3 = (Button) this.findViewById(com.example.artilleryandroid.R.id.ave_3);
		mBtnAve4 = (Button) this.findViewById(com.example.artilleryandroid.R.id.ave_4);
		mEtStart = (EditText) this.findViewById(com.example.artilleryandroid.R.id.et_start);
		mEtEnd = (EditText) this.findViewById(com.example.artilleryandroid.R.id.et_end);
		mEtAve1 = (EditText) this.findViewById(com.example.artilleryandroid.R.id.et_ave1);
		mEtAve2 = (EditText) this.findViewById(com.example.artilleryandroid.R.id.et_ave2);
		mEtAve3 = (EditText) this.findViewById(com.example.artilleryandroid.R.id.et_ave3);
		mEtAve4 = (EditText) this.findViewById(com.example.artilleryandroid.R.id.et_ave4);
		mLayoutAve1 = (LinearLayout) this.findViewById(com.example.artilleryandroid.R.id.layout_ave1);
		mLayoutAve2 = (LinearLayout) this.findViewById(com.example.artilleryandroid.R.id.layout_ave2);
		mLayoutAve3 = (LinearLayout) this.findViewById(com.example.artilleryandroid.R.id.layout_ave3);
		mLayoutAve4 = (LinearLayout) this.findViewById(com.example.artilleryandroid.R.id.layout_ave4);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case com.example.artilleryandroid.R.id.start:
			...
			break;
		case com.example.artilleryandroid.R.id.end:
			if (mEndMarker != null) {
			...
			break;
		case com.example.artilleryandroid.R.id.route:
			// 规划
			...
			if (mAvePoints != null && mAvePoints.size() > 0)
				...
				mRoute.startRoute(mStartPoint, mEndPoint, null,
						TDrivingRoute.DRIVING_TYPE_NOHIGHWAY);
			break;
		case com.example.artilleryandroid.R.id.reset:
			mAvePoints.clear();
			if (mStartMarker != null) {
				mMapView.removeOverlay(mStartMarker);
				mStartMarker = null;
			...
			break;
		case com.example.artilleryandroid.R.id.add_ave:
			mClickIndex++;
			if (mClickIndex > 4)
				return;
			switch (mClickIndex) {
			...
			break;
		case com.example.artilleryandroid.R.id.ave_1:
			if (mAveMarker1 != null) {
				mMapView.removeOverlay(mAveMarker1);
				mAveMarker1 = null;
			}
			...
			break;
		case com.example.artilleryandroid.R.id.ave_2:
			if (mAveMarker2 != null) {
				mMapView.removeOverlay(mAveMarker2);
				mAveMarker2 = null;
			}
			...
			break;
		case com.example.artilleryandroid.R.id.ave_3:
			if (mAveMarker3 != null) {
				mMapView.removeOverlay(mAveMarker3);
				mAveMarker3 = null;
			}
			...
			break;
		case com.example.artilleryandroid.R.id.ave_4:
			if (mAveMarker4 != null) {
				mMapView.removeOverlay(mAveMarker4);
				mAveMarker4 = null;
			}
	...
	public class MyOverlay extends Overlay {
		...
		public MyOverlay(Context con) {
			mDrawableStart = (Drawable) con.getResources().getDrawable(
					com.example.artilleryandroid.R.drawable.icon_route_start);
			mDrawableEnd = (Drawable) con.getResources().getDrawable(
					com.example.artilleryandroid.R.drawable.icon_route_end);
			mDrawableAve = (Drawable) con.getResources().getDrawable(
					com.example.artilleryandroid.R.drawable.icon_route_mid);
		}
	...
	public void onDrivingResult(TDrivingRouteResult result, int errCode) {
		...
		mTrOverlay = new TdrivingRouteOverlay(this, mMapView.getResources()
				.getDrawable(com.example.artilleryandroid.R.drawable.icon_route_mid));
