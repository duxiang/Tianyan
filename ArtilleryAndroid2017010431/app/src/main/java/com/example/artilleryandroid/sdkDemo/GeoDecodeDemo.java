...
public class GeoDecodeDemo extends Activity implements OnGeoResultListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.artilleryandroid.R.layout.geodecodedemo);

		mMapView = (MapView) findViewById(com.example.artilleryandroid.R.id.mapview);
		mMapView.setLogoPos(MapView.LOGO_RIGHT_TOP);
		mMapView.setBuiltInZoomControls(true);

		mEditLon = (EditText) findViewById(com.example.artilleryandroid.R.id.editTextLon);
		mEditLat = (EditText) findViewById(com.example.artilleryandroid.R.id.editTextLat);
		...
		// 添加覆盖物
		Drawable drawable = getResources().getDrawable(com.example.artilleryandroid.R.drawable.icon_overlay_nearby_center);
