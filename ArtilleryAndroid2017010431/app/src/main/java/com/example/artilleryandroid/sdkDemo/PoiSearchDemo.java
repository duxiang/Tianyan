...
public class PoiSearchDemo extends Activity implements OnGetPoiResultListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.artilleryandroid.R.layout.poisearchdemo);
		...
		// type
		mBtnType = (Button) findViewById(com.example.artilleryandroid.R.id.buttonType);
		...
		// edit
		mEditKey = (EditText) findViewById(com.example.artilleryandroid.R.id.editKey);
		mEditKey.setText("餐饮");

		// search
		mBtnSearch = (Button) findViewById(com.example.artilleryandroid.R.id.buttonSearch);
		...
		// list
		mBtnList = (Button) findViewById(com.example.artilleryandroid.R.id.buttonList);
		listener = new OnClickListener() {
		...
		// pre
		mBtnPre = (Button) findViewById(com.example.artilleryandroid.R.id.buttonPre);
		listener = new OnClickListener() {
		...
		// next
		mBtnNext = (Button) findViewById(com.example.artilleryandroid.R.id.buttonNext);
		listener = new OnClickListener() {
		...
		// tips
		mTextTips = ((TextView) findViewById(com.example.artilleryandroid.R.id.textViewTipsdizhixinxi));
		mTextTips.setText("");
