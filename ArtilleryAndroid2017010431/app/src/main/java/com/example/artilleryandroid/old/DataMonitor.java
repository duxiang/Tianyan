...
Sendtempm="初次连接";
   ...
   ZhengX=(long) Xzuizhong;
       ...
       Brom.start();
			    ...
			    */
			}catch (Exception e){	Toast.makeText(DataMonitor.this,"初始化错误，请检查设置后重启", Toast.LENGTH_LONG).show();
			}
			
			 try{mPlayer=MediaPlayer.create(DataMonitor.this,R.raw.warning);
			 mPlayer.setVolume(1.0f, 1.0f); 
			 mPlayer.setLooping(true);
			// mPlayer.start();
		}catch (Exception e){	Toast.makeText(DataMonitor.this,"音乐播放失败", Toast.LENGTH_LONG).show();
		}
		}
		catch (Exception err){}
	}
	...
	public void onStart() {
		...
		try{
			...
			spinner1.setOnItemSelectedListener(new OnItemSelectedListener(){
			    ...
			    Jianceying=spinner1.getSelectedItemPosition();
			    	...
			    	Toast.makeText(DataMonitor.this,"当前单位为"+spinner1.getSelectedItemPosition()+"营"+spinner2.getSelectedItemPosition()+"连"+spinner3.getSelectedItemPosition()+"炮".toString(), Toast.LENGTH_LONG).show();
		...
		catch (Exception err){ Toast.makeText(DataMonitor.this, err.toString(), Toast.LENGTH_LONG).show();
		   }
		...
		.setPositiveButton("确定", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				 ...
				 try{
				    ...
				    Toast.makeText(DataMonitor.this, e.toString(), Toast.LENGTH_LONG).show();
				        	}
