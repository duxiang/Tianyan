...
public class OfflineMapDemo extends Activity implements OnGetMapsResult{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.artilleryandroid.R.layout.offlinemapdemo);
		offlineMapMng = new TOfflineMapManager(this, this);
		offlineMapMng.setMapPath("/sdcard/tianditu/staticmap/");
		mMapView = (MapView)findViewById(com.example.artilleryandroid.R.id.offlinemap_mapview);
...
//		mMapView.setOfflineMaps(offlineMapMng.searchLocalMaps());
		...
		final EditText etCity = (EditText)findViewById(com.example.artilleryandroid.R.id.offlinemap_et_city);
		Button   btn = (Button)findViewById(com.example.artilleryandroid.R.id.offlinemap_btn_start);
		...
		btn = (Button)findViewById(com.example.artilleryandroid.R.id.offlinemap_btn_pause);
		btn.setOnClickListener(new OnClickListener(){
		...
		mPb = (ProgressBar)findViewById(com.example.artilleryandroid.R.id.offlinemap_progress);
