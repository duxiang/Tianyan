...
public class MapControllDemo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.artilleryandroid.R.layout.mapcontrolldemo);
		...
		inflater.inflate(com.example.artilleryandroid.R.layout.mapcontrolldemotab1, contentView);
		inflater.inflate(com.example.artilleryandroid.R.layout.mapcontrolldemotab2, contentView);
		inflater.inflate(com.example.artilleryandroid.R.layout.mapcontrolldemotab3, contentView);
	...
	class Tab1 {
		...
		public Tab1(Activity activity, View view) {
			...
			mBtnSetCenter = (Button) view.findViewById(com.example.artilleryandroid.R.id.buttonCenter);
			...
			mMarker.setIcon(activity.getResources().getDrawable(com.example.artilleryandroid.R.drawable.poiresult));
	...
	class Tab2 {
        ...
        public Tab2(Activity activity, View view) {
			...
			mEditLonSpan = (EditText) view.findViewById(com.example.artilleryandroid.R.id.editTextLonSpan);
			mEditLatSpan = (EditText) view.findViewById(com.example.artilleryandroid.R.id.editTextLatSpan);

			mBtnSetBound = (Button) view.findViewById(com.example.artilleryandroid.R.id.buttonBound);
			...
			mSeekLevel = (SeekBar) view.findViewById(com.example.artilleryandroid.R.id.seekBarLevel);
			...
			mTextLevel = (TextView) view.findViewById(com.example.artilleryandroid.R.id.textViewLevel);
	...
	class Tab3 {
		...
		public Tab3(Activity activity, View view) {
			// 旋转
			mSeekRotate = (SeekBar) view.findViewById(com.example.artilleryandroid.R.id.seekBarRotate);
			...
			mTextRotate = (TextView) view.findViewById(com.example.artilleryandroid.R.id.textViewRotate);

			// 俯视
			mSeekLookdown = (SeekBar) view.findViewById(com.example.artilleryandroid.R.id.seekBarLookdown);
			...
			mTextLookdown = (TextView) view.findViewById(com.example.artilleryandroid.R.id.textViewLookdown);
