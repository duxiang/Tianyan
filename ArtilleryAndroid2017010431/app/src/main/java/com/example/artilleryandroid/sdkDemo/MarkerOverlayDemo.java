...
public class MarkerOverlayDemo extends Activity implements OnMarkerClickListener,
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.artilleryandroid.R.layout.markeroverlaydemo);
		...
		mCbDraggable = (CheckBox) this.findViewById(com.example.artilleryandroid.R.id.draggable);
		mIvMarker = (ImageView) this.findViewById(com.example.artilleryandroid.R.id.imageViewMarker);
		updateTips(null);
	}
