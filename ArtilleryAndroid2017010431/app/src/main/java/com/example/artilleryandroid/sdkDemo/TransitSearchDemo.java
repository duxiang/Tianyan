...
public class TransitSearchDemo extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCon = this;
		setContentView(com.example.artilleryandroid.R.layout.transitsearch);
		mMapView = (MapView) this.findViewById(com.example.artilleryandroid.R.id.mapview);
		mList = (ListView) findViewById(com.example.artilleryandroid.R.id.list);
		mSearch = (Button) this.findViewById(com.example.artilleryandroid.R.id.bus_route);
		mBtnList = (Button) this.findViewById(com.example.artilleryandroid.R.id.bus_list);
		mTextTitle = (TextView) this.findViewById(com.example.artilleryandroid.R.id.bus_title);
		mTextStart = (TextView) this.findViewById(com.example.artilleryandroid.R.id.bus_start);
		mTextEnd = (TextView) this.findViewById(com.example.artilleryandroid.R.id.bus_end);
		mTextContent = (TextView) this.findViewById(com.example.artilleryandroid.R.id.bus_content);
	...
	public void onTransitResult(TTransitResult result, int error) {
		...
		this.mTrOverlay = new TransitRouteOverlay(mCon,mMapView.getResources().getDrawable(com.example.artilleryandroid.R.drawable.icon_bus_station));
