...
public class ItemizedOverlayDemo extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.artilleryandroid.R.layout.itemizedoverlaydemo);
        
        // 地图视图
        mMapView = (MapView) findViewById(com.example.artilleryandroid.R.id.itemized_mapview);
        ...
        inflater.inflate(com.example.artilleryandroid.R.layout.itemizedoverlaydemotab1, contentView);
        inflater.inflate(com.example.artilleryandroid.R.layout.itemizedoverlaydemotab2, contentView);
        ...
        list.add(myLocation);
        Drawable marker = getResources().getDrawable(com.example.artilleryandroid.R.drawable.poi_xml);
        mOverlay = new OverItemT(marker);
        mOverlay.setOnFocusChangeListener(this);
        list.add(mOverlay);

        // 创建弹出框view
        mPopView = super.getLayoutInflater().inflate(com.example.artilleryandroid.R.layout.popview, null);
        mText = (TextView) mPopView.findViewById(com.example.artilleryandroid.R.id.text);
        mMapView.addView(mPopView, new LayoutParams(
	...
	class Tab1 {
        ...
        public Tab1(View view) {
            mShowFocus = (CheckBox) view.findViewById(com.example.artilleryandroid.R.id.showFocus);
            mBtnUp = (Button) view.findViewById(com.example.artilleryandroid.R.id.buttonup);
            mBtnDown = (Button) view.findViewById(com.example.artilleryandroid.R.id.buttondown);
            mTvFocus = (TextView) view.findViewById(com.example.artilleryandroid.R.id.textViewFocus);
            mTvTips = (TextView) view.findViewById(com.example.artilleryandroid.R.id.textViewTips);
    ...
    class Tab2 {
        ...
        public Tab2(View view) {
            ...
            mTvPoint = (TextView) view.findViewById(com.example.artilleryandroid.R.id.textViewpoint);
            mTvSpan = (TextView) view.findViewById(com.example.artilleryandroid.R.id.textViewspan);
            mBtnSet = (Button) view.findViewById(com.example.artilleryandroid.R.id.buttonset);
	...
	static class OverItemT extends ItemizedOverlay<OverlayItem> implements
		...
		protected boolean onTap(int i) {
			...
			ItemizedOverlayDemo.mMapView.updateViewLayout(
					ItemizedOverlayDemo.mPopView, new LayoutParams(
