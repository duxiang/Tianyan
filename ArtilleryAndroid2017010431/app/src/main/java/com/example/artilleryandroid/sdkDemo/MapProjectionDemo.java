...
public class MapProjectionDemo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.artilleryandroid.R.layout.mapprojectiondemo);
		...
		inflater.inflate(com.example.artilleryandroid.R.layout.mapprojectiondemotab1, contentView);
		inflater.inflate(com.example.artilleryandroid.R.layout.mapprojectiondemotab2, contentView);
	...
	class Tab1 {
		...
		public Tab1(Activity activity, View view) {
			mEditScreenX = (EditText) view.findViewById(com.example.artilleryandroid.R.id.editTextScreenX);
			mEditScreenY = (EditText) view.findViewById(com.example.artilleryandroid.R.id.editTextScreenY);

			mBtnTransform = (Button) view.findViewById(com.example.artilleryandroid.R.id.buttonTransform);
