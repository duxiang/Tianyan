...
public class BusStationIDSearchDemo extends Activity implements OnStationResultListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.example.artilleryandroid.R.layout.busstationidsearchdemo);
		...
		// edit
		mEditID = (EditText) this.findViewById(com.example.artilleryandroid.R.id.editID);
		...
		// tips
		mTextTips = (TextView) findViewById(com.example.artilleryandroid.R.id.textViewTips);
		mTextTips.setText("");
	}
	...
	public void onStationResult(TBusStationInfo info, int error) {
		...
		// 添加覆盖物
		Drawable drawable = getResources().getDrawable(com.example.artilleryandroid.R.drawable.icon_busroute_change_sub);
