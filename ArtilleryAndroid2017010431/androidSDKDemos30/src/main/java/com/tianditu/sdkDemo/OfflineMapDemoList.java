...
import com.tianditu.sdkDemo.Offline.AllMapAdapter;
import com.tianditu.sdkDemo.Offline.DownLoadedAdapter;
import com.tianditu.sdkDemo.Offline.DownLoadingAdapter;
...
public class OfflineMapDemoList extends Activity implements OnClickListener, OnGetMapsResult, OnDownLoadResult, OnChildClickListener,OnMapParamChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.offlinemapdemolist);
		...
		TextView textPath = (TextView) findViewById(R.id.text_path);
